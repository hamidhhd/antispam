...
if Company.from.id == 485557696 or Company.from.id == 509620850 then
if redis:get('CheckBot:'..chat_id) then
local keyboard = {}
keyboard.inline_keyboard = {{{text = '• Log into management menu', callback_data = 'Menu:'..chat_id}},{{text= '• Exit' ,callback_data = 'Exit:'..chat_id}},{{text="• Join our channel",url="https://telegram.me/TeleSudoB"}}}
AnswerInline(Company.id,'settings','Group settings',chat_id,'• *The management menu was requested by:* `'..Company.from.first_name ..'`\n\n@TeleSudoB','Markdown',keyboard)
else
local keyboard = {}
keyboard.inline_keyboard = {{{text="Join our channel",url="https://telegram.me/TelesudoB"}}}			
